...
public class QFreeQueueDto {
    ...
    public String toString() {
        return "LprQueueDto [cscLookUpKey=" + cscLookUpKey + ", issPassageId=" + issPassageId + ", ortFlag=" + ortFlag
                ...
                + ", isEntry=" + isEntry + ", laneTxId=" + laneTxId + ", unmatchedEntryFlag=" + unmatchedEntryFlag
    ...
    public static QFreeQueueDto dtoFromJson(String message)
	{
		
    	QFreeQueueDto queueMessageDTO = null;
		Gson gson = new Gson();
		queueMessageDTO = gson.fromJson(message, QFreeQueueDto.class);
